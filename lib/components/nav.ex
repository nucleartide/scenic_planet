defmodule ScenicPlanet.Component.Nav do
  ...
  def init( current_scene, opts ) do
    ...
    |> dropdown({[
        {"Sensor", ScenicPlanet.Scene.Sensor},
        {"Primitives", ScenicPlanet.Scene.Primitives},
        {"Components", ScenicPlanet.Scene.Components},
        {"Transforms", ScenicPlanet.Scene.Transforms},
